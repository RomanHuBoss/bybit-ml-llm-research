...
Первая строка обязательна и должна иметь вид: ВЕРДИКТ: <НЕТ ВХОДА | НАБЛЮДАТЬ | К РУЧНОЙ ПРОВЕРКЕ> — <короткая причина>.
Дальше дай 3-5 коротких пунктов: почему сигнал можно рассматривать, почему его надо отклонить или отложить, какие условия invalidation.
...
""".strip()
    return ollama_generate(
        prompt,
        system="Ты риск-менеджер и quant-research аналитик. Пиши по-русски, кратко, структурно, без инвестиционных гарантий. Всегда начинай с явного ВЕРДИКТ.",
        temperature=0.2,
    )
