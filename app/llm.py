...
Первая строка обязательна и должна быть строго одним из трех вариантов, без пояснений в той же строке:
ВЕРДИКТ: ДА, ВХОД ПОДТВЕРЖДАЮ
ВЕРДИКТ: НЕТ, ВХОД НЕ ПОДТВЕРЖДАЮ
ВЕРДИКТ: НАБЛЮДАТЬ, ВХОД НЕ ПОДТВЕРЖДАЮ
После вердикта дай максимум 2 коротких пункта: ключевой риск и что проверить вручную.
