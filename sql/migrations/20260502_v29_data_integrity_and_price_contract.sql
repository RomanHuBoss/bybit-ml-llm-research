-- V29: data integrity hardening + stored recommendation TTL.
-- Safe to re-run. Constraints are NOT VALID to avoid blocking legacy rows while
-- still protecting every new/updated row after the migration is installed.
